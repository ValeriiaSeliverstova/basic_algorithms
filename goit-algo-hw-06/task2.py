...
# Вимірювання часу виконання DFS
dfs_path = dfs(G, "Червоний хутір")
dfs_time = timeit.timeit(lambda: dfs(G, "Хрещатик"), number=100)
print(f"Час виконання DFS: {dfs_time} секунд (для 100 виконань)")
print(f"DFS path: {dfs_path}")
print("-----------------------------------------------------------------------------------------------------------------------")
print("-----------------------------------------------------------------------------------------------------------------------")
print("-----------------------------------------------------------------------------------------------------------------------")

# Вимірювання часу виконання BFS
bfs_path = bfs(G, "Червоний хутір")
bfs_time = timeit.timeit(lambda: bfs(G, "Хрещатик"), number=100)
print(f"Час виконання BFS: {bfs_time} секунд (для 100 виконань)")
